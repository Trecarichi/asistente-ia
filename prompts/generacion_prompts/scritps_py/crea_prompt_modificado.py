...
def formatear_links_y_emails(texto):
    """
    Detecta URLs y correos en el texto y los reemplaza por su versión clickeable en Markdown.
    Ejemplo:
      https://sitio.com  →  [https://sitio.com](https://sitio.com)
      contacto@correo.com → [contacto@correo.com](mailto:contacto@correo.com)
    """
    # Reemplazar emails
    texto = re.sub(
        r'(?<!\w)([\w\.-]+@[\w\.-]+\.\w+)',
