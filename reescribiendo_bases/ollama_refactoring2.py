...
# Definición de las listas de palabras clave para respuestas estáticas
KEYWORDS_BENEFICIOS = ["beneficios", "ganancias", "ventajas", "a favor"]
KEYWORDS_REQUISITOS = ["requisitos", "papeles", "documentos", "que necesito"]
KEYWORDS_DIRECCIONES = ["direcciones", "ubicación", "donde ir", "dirección", "ubicacion"]
ic(KEYWORDS_BENEFICIOS)
ic(KEYWORDS_REQUISITOS)
ic(KEYWORDS_DIRECCIONES)
...
def process_prompt(prompt):
    ...
    if any(keyword in user_question_lower for keyword in KEYWORDS_BENEFICIOS):
    ...
    if any(keyword in user_question_lower for keyword in KEYWORDS_REQUISITOS):
    ...
    if any(keyword in user_question_lower for keyword in KEYWORDS_DIRECCIONES):
...
if __name__ == '__main__':
    ...
    if not db_conn:
        ...
        print(f"Hola, soy un asistente virtual del Ministerio de Justicia y Derechos Humanos de la Provincia de Buenos Aires.\n"
              f"Puedo orientarte sobre el programa: \"Mi Escritura, Mi Casa\".\n"
